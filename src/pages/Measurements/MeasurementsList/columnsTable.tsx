...
import { EntityMeasurementTable } from "types/models/EntityMeasurement";
...
const columnsTable = ({
	...
	sort,
	handleSortChange,
}: ColumnsTableProps): ColumnsType<EntityMeasurementTable> => {
	return [
		{
			key: "name",
			title: (
		...
		},
		{
			...
			render: (_, data) => {
				return (
					<TableActions>
						<Link to={generatePath(authUrl.Index.Measurements.Edit.url, { id: data.id })}>
