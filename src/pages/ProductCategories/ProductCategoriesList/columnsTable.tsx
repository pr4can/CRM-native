...
import { EntityProductCategoryTable } from "types/models/EntityProductCategory";
...
const columnsTable = ({
	...
	sort,
	handleSortChange,
}: ColumnsTableProps): ColumnsType<EntityProductCategoryTable> => {
	return [
		{
			key: "name",
			title: (
		...
		},
		{
			...
			render: (_, data) => {
				return (
					<TableActions>
						<Link to={generatePath(authUrl.Index.ProductCategories.Edit.url, { id: data.id })}>
