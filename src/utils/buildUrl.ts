...
const builder = <E extends Enum<E>, P extends Pattern<E>>(path: E, pattern?: P, currentUrl: string = ""): Url<E, P> => {
	if (!pattern) {
		return {} as Url<E, P>;
	}
...
const buildUrl = <E extends Enum<E>, P extends Pattern<E>>(path: E, pattern: P): Url<E, P> => {
